...
const routes = [
    ...
    {
        path: "payment",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-payment-payment-module */ "pages-payment-payment-module").then(__webpack_require__.bind(null, /*! ./pages/payment/payment.module */ "mDHw")).then((m) => m.PaymentPageModule),
    },
    {
        path: "newhome",
